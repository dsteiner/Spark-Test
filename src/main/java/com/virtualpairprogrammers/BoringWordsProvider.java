...
// from com.virtualpairprogrammers.Util;
 ...
 */
public class BoringWordsProvider
{
	...
	static {
		...
		InputStream is = BoringWordsProvider.class.getResourceAsStream("/subtitles/boringwords.txt");
